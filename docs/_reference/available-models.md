...
nav_order: 1
description: Browse 1218 AI models across 12 providers (not including local providers). Updated 2026-03-12.
redirect_from:
...
| gemini-3.1-flash-lite-preview | gemini | In: text, image, video, audio, pdf; Out: text | function_calling, structured_output, reasoning, vision, streaming, batch | 1048576 | 65536 | In: $0.50, Out: $3.00, Cache: $0.05 |
...
| Model | Provider | I/O | Capabilities | Context | Max Output | Standard Pricing (per 1M tokens) |
| :-- | :-- | :-- | :-- | --: | --: | :-- |
| BAAI/bge-en-icl | nebius | In: text; Out: text | - | 32768 | 0 | In: $0.01 |
| deepseek-ai/DeepSeek-R1-0528-fast | nebius | In: text; Out: text | function_calling, reasoning | 131072 | 8192 | In: $2.00, Out: $6.00 |
| deepseek-ai/DeepSeek-R1-0528 | nebius | In: text; Out: text | function_calling, structured_output, reasoning | 128000 | 32768 | In: $0.80, Out: $2.40, Cache: $0.08 |
| deepseek-ai/DeepSeek-V3-0324 | nebius | In: text; Out: text | function_calling, structured_output | 128000 | 8192 | In: $0.50, Out: $1.50, Cache: $0.05 |
| deepseek-ai/DeepSeek-V3-0324-fast | nebius | In: text; Out: text | function_calling, structured_output | 128000 | 8192 | In: $0.75, Out: $2.25, Cache: $0.08 |
| deepseek-ai/DeepSeek-V3.2 | nebius | In: text; Out: text | function_calling, structured_output, reasoning | 163000 | 16384 | In: $0.30, Out: $0.45, Cache: $0.03 |
| black-forest-labs/flux-dev | nebius | In: text; Out: image | - | 77 | 0 | - |
| black-forest-labs/flux-schnell | nebius | In: text; Out: image | - | 77 | 0 | - |
| zai-org/GLM-4.5 | nebius | In: text; Out: text | function_calling, structured_output | 128000 | 4096 | In: $0.60, Out: $2.20, Cache: $0.06 |
| zai-org/GLM-4.5-Air | nebius | In: text; Out: text | function_calling, structured_output | 128000 | 4096 | In: $0.20, Out: $1.20, Cache: $0.02 |
| zai-org/GLM-4.7-FP8 | nebius | In: text; Out: text | function_calling, structured_output | 128000 | 4096 | In: $0.40, Out: $2.00, Cache: $0.04 |
| zai-org/GLM-5 | nebius | In: text; Out: text | function_calling, structured_output, reasoning | 202752 | 16384 | In: $1.00, Out: $3.20, Cache: $0.10 |
| google/gemma-2-2b-it | nebius | In: text; Out: text | - | 8192 | 4096 | In: $0.02, Out: $0.06, Cache: $0.00 |
| google/gemma-2-9b-it-fast | nebius | In: text; Out: text | - | 8192 | 4096 | In: $0.03, Out: $0.09, Cache: $0.00 |
| google/gemma-3-27b-it | nebius | In: text, image; Out: text | function_calling, structured_output, vision | 110000 | 8192 | In: $0.10, Out: $0.30, Cache: $0.01 |
| google/gemma-3-27b-it-fast | nebius | In: text, image; Out: text | function_calling, structured_output, vision | 110000 | 8192 | In: $0.20, Out: $0.60, Cache: $0.02 |
| NousResearch/Hermes-4-405B | nebius | In: text; Out: text | function_calling, structured_output, reasoning | 128000 | 8192 | In: $1.00, Out: $3.00, Cache: $0.10 |
| NousResearch/Hermes-4-70B | nebius | In: text; Out: text | function_calling, structured_output, reasoning | 128000 | 8192 | In: $0.13, Out: $0.40, Cache: $0.01 |
| PrimeIntellect/INTELLECT-3 | nebius | In: text; Out: text | function_calling, structured_output | 128000 | 8192 | In: $0.20, Out: $1.10, Cache: $0.02 |
| moonshotai/Kimi-K2-Instruct | nebius | In: text, image; Out: text | function_calling, structured_output, vision | 200000 | 8192 | In: $0.50, Out: $2.40, Cache: $0.05 |
| moonshotai/Kimi-K2-Thinking | nebius | In: text; Out: text | function_calling, structured_output, reasoning | 128000 | 16384 | In: $0.60, Out: $2.50, Cache: $0.06 |
| moonshotai/Kimi-K2.5 | nebius | In: text, image; Out: text | function_calling, structured_output, reasoning, vision | 262144 | 8192 | In: $0.50, Out: $2.50, Cache: $0.05 |
| nvidia/Llama-3_1-Nemotron-Ultra-253B-v1 | nebius | In: text; Out: text | function_calling, structured_output | 128000 | 4096 | In: $0.60, Out: $1.80, Cache: $0.06 |
| meta-llama/Llama-3.3-70B-Instruct | nebius | In: text; Out: text | function_calling, structured_output | 128000 | 8192 | In: $0.13, Out: $0.40, Cache: $0.01 |
| meta-llama/Llama-3.3-70B-Instruct-fast | nebius | In: text; Out: text | function_calling, structured_output | 128000 | 8192 | In: $0.25, Out: $0.75, Cache: $0.02 |
| meta-llama/Llama-Guard-3-8B | nebius | In: text; Out: text | structured_output | 8192 | 1024 | In: $0.02, Out: $0.06, Cache: $0.00 |
| meta-llama/Meta-Llama-3.1-8B-Instruct | nebius | In: text; Out: text | function_calling, structured_output | 128000 | 4096 | In: $0.02, Out: $0.06, Cache: $0.00 |
| meta-llama/Meta-Llama-3.1-8B-Instruct-fast | nebius | In: text; Out: text | function_calling, structured_output | 128000 | 4096 | In: $0.03, Out: $0.09, Cache: $0.00 |
| MiniMaxAI/MiniMax-M2.1 | nebius | In: text; Out: text | function_calling, structured_output, reasoning | 128000 | 8192 | In: $0.30, Out: $1.20, Cache: $0.03 |
| nvidia/NVIDIA-Nemotron-3-Nano-30B-A3B | nebius | In: text; Out: text | function_calling, structured_output | 32000 | 4096 | In: $0.06, Out: $0.24, Cache: $0.01 |
| nvidia/Nemotron-Nano-V2-12b | nebius | In: text; Out: text | function_calling, structured_output | 32000 | 4096 | In: $0.07, Out: $0.20, Cache: $0.01 |
| Qwen/Qwen2.5-Coder-7B-fast | nebius | In: text; Out: text | function_calling, structured_output | 128000 | 8192 | In: $0.03, Out: $0.09, Cache: $0.00 |
| Qwen/Qwen2.5-VL-72B-Instruct | nebius | In: text, image; Out: text | function_calling, structured_output, vision | 128000 | 8192 | In: $0.25, Out: $0.75, Cache: $0.02 |
| Qwen/Qwen3-235B-A22B-Instruct-2507 | nebius | In: text; Out: text | function_calling, reasoning | 262144 | 8192 | In: $0.20, Out: $0.60 |
| Qwen/Qwen3-235B-A22B-Thinking-2507 | nebius | In: text; Out: text | function_calling, reasoning | 262144 | 8192 | In: $0.20, Out: $0.80 |
| Qwen/Qwen3-Coder-480B-A35B-Instruct | nebius | In: text; Out: text | function_calling | 262144 | 66536 | In: $0.40, Out: $1.80 |
| Qwen/Qwen3-30B-A3B-Instruct-2507 | nebius | In: text; Out: text | function_calling, structured_output | 128000 | 8192 | In: $0.10, Out: $0.30, Cache: $0.01 |
| Qwen/Qwen3-30B-A3B-Thinking-2507 | nebius | In: text; Out: text | function_calling, structured_output, reasoning | 128000 | 16384 | In: $0.10, Out: $0.30, Cache: $0.01 |
| Qwen/Qwen3-32B | nebius | In: text; Out: text | function_calling, structured_output | 128000 | 8192 | In: $0.10, Out: $0.30, Cache: $0.01 |
| Qwen/Qwen3-32B-fast | nebius | In: text; Out: text | function_calling, structured_output | 128000 | 8192 | In: $0.20, Out: $0.60, Cache: $0.02 |
| Qwen/Qwen3-Coder-30B-A3B-Instruct | nebius | In: text; Out: text | function_calling, structured_output | 128000 | 8192 | In: $0.10, Out: $0.30, Cache: $0.01 |
| Qwen/Qwen3-Embedding-8B | nebius | In: text; Out: text | - | 32768 | 0 | In: $0.01 |
| Qwen/Qwen3-Next-80B-A3B-Thinking | nebius | In: text; Out: text | function_calling, structured_output, reasoning | 128000 | 16384 | In: $0.15, Out: $1.20, Cache: $0.02 |
| BAAI/bge-multilingual-gemma2 | nebius | In: text; Out: text | - | 8192 | 0 | In: $0.01 |
| intfloat/e5-mistral-7b-instruct | nebius | In: text; Out: text | - | 32768 | 0 | In: $0.01 |
| openai/gpt-oss-120b | nebius | In: text; Out: text | function_calling, structured_output, reasoning | 128000 | 8192 | In: $0.15, Out: $0.60, Cache: $0.02 |
| openai/gpt-oss-20b | nebius | In: text; Out: text | function_calling, structured_output | 128000 | 4096 | In: $0.05, Out: $0.20, Cache: $0.01 |
